...
insert into sensor (tiposensor,statussensor,fkervas,fkusuario) values
	...
	select sensor.*, ervas.nome, usuario.razaosocial from sensor, ervas, usuario where fkervas=idervas and fkusuario=idusuario and idUsuario =101;
    
   insert into sensor (tiposensor,statussensor,fkervas,fkusuario) values
	('luminosidade','inativo',3,100);
